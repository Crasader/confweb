...
function check(){
	...
	iter = document.getElementsByName("school")
	i = iter[0].value
	if(i == "")
	{
		alert("学校名不能为空！")
...
<div class="cbody b-box blank10">
	...
	<?php switch($dsp): ?><?php case "detail":  ?><h4><a href="__APP__/InvitedSpeaker">邀请的演讲者管理</a>>><?php echo ($title); ?></h4>
			...
			<tr><th>学校</th><td><input type="text" name="school" value="<?php echo ($person["school"]); ?>" /></td></tr>
			...
			<input type="hidden" name="id" value="<?php echo ($_GET['id']); ?>"></td></tr>
			</table>
