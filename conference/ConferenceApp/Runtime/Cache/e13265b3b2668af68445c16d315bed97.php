...
<title>会议地点</title>
<table border="1">
<?php if(is_array($place)): $i = 0; $__LIST__ = $place;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr><td rowspan="3"><image src="<?php echo ($vo["photo"]); ?>"></td><td><?php echo ($vo["confname"]); ?>(<?php echo ($vo["time"]); ?>)</td></tr>
